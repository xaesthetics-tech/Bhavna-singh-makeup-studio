...
const SERVICE_DATA = [
  {
    number: "01",
    name: "Makeup",
    description: "Makeup artistry for celebrations, special occasions and your signature look.",
    startingPrice: "Price on request",
    image: "https://i.ibb.co/hR6Q0yDg/0e40e640c907bf139b15e30eebd1e17b.jpg",
    subcategories: [
...

  {
    ...
    startingPrice: "Price on request",
    image: "https://i.ibb.co/9Hg8TT09/Screenshot-20260922-114324-Maps.jpg",
    subcategories: [
      { name: "Bridal Makeup", price: "Price on request" },
...

  {
    number: "03",
    name: "Hair",
    description: "Thoughtful cuts, styling and care to complement your overall look.",
    startingPrice: "Price on request",
    image: "https://i.ibb.co/5WBCb4fd/Screenshot-20260922-114346-Maps.jpg",
    subcategories: [
...

  {
    ...
    startingPrice: "Price on request",
    image: "https://i.ibb.co/50jkhyx/Screenshot-20260922-114408-Maps.jpg",
    subcategories: [
...

  {
    number: "05",
    name: "Nails",
    description: "Clean finishes and delicate details for polished hands and feet.",
    startingPrice: "Price on request",
    image: "https://i.ibb.co/938Wtb9b/Screenshot-20260922-114526-Maps.jpg",
    subcategories: [
...
function setupEnquiryForm() {
  ...
  form.addEventListener("submit", event => {
    ...
    status.textContent =
      ...
      "demo only. It has not been sent to the studio. Connect a secure " +
